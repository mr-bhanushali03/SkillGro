        ...
        options: {
            ...
            patterns: {
                youtube: {
                    ...
                    getSrc: function (url, videoId) {
                        // If it's YouTube, return the YouTube video URL
                        return (
                ...
                vimeo: {
                    ...
                    getSrc: function (url, videoId) {
                        // If it's Vimeo, return the Vimeo video URL
                        return (
                ...
                gmaps: {
                    check: function (url) {
                        // Check if the URL matches the Google Maps pattern
                        return url.indexOf("//maps.google.") > -1;
                    },
                    getSrc: function (url, videoId) {
                        // If it's Google Maps, return the Google Maps embed URL
                        return videoId + "&output=embed";
                    },
                },
            },
        },
