...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('storage/dashboard') }}/images/favicon.ico">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('storage/dashboard') }}/images/logo-sm.png" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('storage/dashboard') }}/images/logo-dark.png" alt="" height="17">
                                </span>
                            </a>
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('storage/dashboard') }}/images/logo-light.png" alt="" height="17">
                                </span>
                            </a>
                        </div>
                            ...
                            <button type="button" class="btn" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="{{ asset('storage/dashboard') }}/images/users/avatar-1.jpg" alt="Header Avatar">
