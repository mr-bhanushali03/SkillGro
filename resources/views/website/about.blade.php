            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-9">
                    <div class="about__images-three tg-svg">
                        <img src="{{ asset('storage/website') }}/img/others/inner_about_img.png" alt="img">
                        <span class="svg-icon" id="about-svg" data-svg-icon="{{ asset('storage/website') }}/img/others/inner_about_shape.svg"></span>
                ...
                <div class="col-lg-6">
                    <div class="about__content-three">
                        ...
                        <p class="desc">Embark on a transformative learning experience with our online courses. Expert instructors, flexible schedules, and cutting-edge content await, empowering you to succeed at your own pace.</p>
                        ...
                        <div class="tg-button-wrap">
                            <a href="{{ url('contact') }}" class="btn arrow-btn">Start Free Trial <img src="{{ asset('storage/website') }}/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section__title white-title text-center mb-50">
                        <span class="sub-title">Start Your Learning Journey</span>
                        <h2 class="title">Embark on a Path to Knowledge Today!</h2>
                        <p>Our user-friendly shared inbox makes team collaboration a breeze, helping members organize, prioritize, and work together seamlessly.</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="features__item">
                        <div class="features__icon">
                            <img src="{{ asset('storage/website') }}/img/icons/features_icon01.svg" class="injectable" alt="img">
                        </div>
                        <div class="features__content">
                            <h4 class="title">Learn with Experts</h4>
                            <p>Explore curated content shared by experts to enhance your skills and knowledge.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="features__item">
                        <div class="features__icon">
                            <img src="{{ asset('storage/website') }}/img/icons/features_icon02.svg" class="injectable" alt="img">
                        </div>
                        <div class="features__content">
                            <h4 class="title">Learn Anything</h4>
                            <p>Dive into a diverse range of learning opportunities with content tailored to your interests.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="features__item">
                        <div class="features__icon">
                            <img src="{{ asset('storage/website') }}/img/icons/features_icon03.svg" class="injectable" alt="img">
                        </div>
                        <div class="features__content">
                            <h4 class="title">Get Online Certificate</h4>
                            <p>Achieve your learning milestones and earn certificates recognized in the online world.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="features__item">
                        <div class="features__icon">
                            <img src="{{ asset('storage/website') }}/img/icons/features_icon04.svg" class="injectable" alt="img">
                        </div>
                        <div class="features__content">
                            <h4 class="title">E-mail Marketing</h4>
                            <p>Discover effective strategies for email marketing to enhance your communication skills.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5">
                    <div class="section__title text-center mb-50">
                        ...
                        <p>See what our students have to say about their learning journey with us.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                                        ...
                                        <div class="testimonial__item-top">
                                            <div class="testimonial__author">
                                                <div class="testimonial__author-thumb">
                                                    <img src="{{ asset('storage/website') }}/img/others/testi_author01.png" alt="img">
                                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial__item">
                                        <div class="testimonial__item-top">
                                            <div class="testimonial__author">
                                                <div class="testimonial__author-thumb">
                                                    <img src="{{ asset('storage/website') }}/img/others/testi_author02.png" alt="img">
                                                </div>
                                                <div class="testimonial__author-content">
                                                    <div class="rating">
                                                        <i class="fas fa-star"></i>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial__item">
                                        <div class="testimonial__item-top">
                                            <div class="testimonial__author">
                                                <div class="testimonial__author-thumb">
                                                    <img src="{{ asset('storage/website') }}/img/others/testi_author03.png" alt="img">
                                                </div>
                                                <div class="testimonial__author-content">
                                                    <div class="rating">
                                                        <i class="fas fa-star"></i>
