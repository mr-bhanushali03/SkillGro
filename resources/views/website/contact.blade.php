                    ...
                    <div class="col-lg-4">
                        <div class="contact-info-wrap">
                            <ul class="list-wrap">
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('storage/website') }}/img/icons/map.svg" alt="img" class="injectable">
                                    </div>
                                    <div class="content">
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('storage/website') }}/img/icons/contact_phone.svg" alt="img" class="injectable">
                                    </div>
                                    <div class="content">
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('storage/website') }}/img/icons/emial.svg" alt="img" class="injectable">
                                    </div>
                                    <div class="content">
                    ...
                    <div class="col-lg-8">
                        <div class="contact-form-wrap">
                            ...
                            <form id="contact-form" action="assets/mail.php" method="POST">
                                ...
                                <button type="submit" class="btn btn-two arrow-btn">Submit Now <img src="{{ asset('storage/website') }}/img/icons/right_arrow.svg" alt="img" class="injectable"></button>
                            </form>
