@include('website.common.header')
    ...
    <main class="main-area fix">
        ...
        <!-- breadcrumb-area -->
        <div class="breadcrumb__area breadcrumb__bg breadcrumb__bg-two" data-background="{{ asset('storage/website') }}/img/bg/breadcrumb_bg.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                                                                ...
                                                                <a href="#" class="course-item-link">
                                                                    ...
                                                                    <div class="course-item-meta">
                                                                        ...
                                                                        <span class="item-meta course-item-status">
                                                                            <img src="{{ asset('storage/website') }}/img/icons/lock.svg" alt="icon">
                                                                        </span>
                                                                    </div>
                                                                </a>
                                                            </li>
                                ...
                                <div class="tab-pane fade" id="instructors-tab-pane" role="tabpanel" aria-labelledby="instructors-tab" tabindex="0">
                                    <div class="courses__instructors-wrap">
                                        <div class="courses__instructors-thumb">
                                            <img src="{{ asset('storage/website') }}/img/courses/course_instructors.png" alt="img">
                                        </div>
                                    ...
                                    <div class="courses__rating-wrap">
                                        ...
                                        <div class="course-review-head">
                                            <div class="review-author-thumb">
                                                <img src="{{ asset('storage/website') }}/img/courses/review-author.png" alt="img">
                                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="courses__details-sidebar">
                            ...
                            <div class="courses__information-wrap">
                                ...
                                <ul class="list-wrap">
                                    <li>
                                        <img src="{{ asset('storage/website') }}/img/icons/course_icon01.svg" alt="img" class="injectable">
                                        Level
                                        <span>Expert</span>
                                    </li>
                                    <li>
                                        <img src="{{ asset('storage/website') }}/img/icons/course_icon02.svg" alt="img" class="injectable">
                                        Duration
                                        <span>11h 20m</span>
                                    </li>
                                    <li>
                                        <img src="{{ asset('storage/website') }}/img/icons/course_icon03.svg" alt="img" class="injectable">
                                        Lessons
                                        <span>12</span>
                                    </li>
                                    <li>
                                        <img src="{{ asset('storage/website') }}/img/icons/course_icon04.svg" alt="img" class="injectable">
                                        Quizzes
                                        <span>145</span>
                                    </li>
                                    <li>
                                        <img src="{{ asset('storage/website') }}/img/icons/course_icon05.svg" alt="img" class="injectable">
                                        Certifications
                                        <span>Yes</span>
                                    </li>
                                    <li>
                                        <img src="{{ asset('storage/website') }}/img/icons/course_icon06.svg" alt="img" class="injectable">
                                        Graduation
                                        <span>25K</span>
                                    </li>
                                </ul>
                            ...
                            <div class="courses__details-enroll">
                                <div class="tg-button-wrap">
                                    <a href="{{ url('courses') }}" class="btn btn-two arrow-btn">
                                        See All Instructors
                                        <img src="{{ asset('storage/website') }}/img/icons/right_arrow.svg" alt="img" class="injectable">
                                    </a>
                                </div>
                            </div>
                        </div>
