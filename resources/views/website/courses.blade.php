                                ...
                                <div class="row courses__grid-wrap row-cols-1 row-cols-xl-3 row-cols-lg-2 row-cols-md-2 row-cols-sm-1">
                                    ...
                                    <div class="col">
                                        <div class="courses__item shine__animate-item">
                                            <div class="courses__item-thumb">
                                                <a href="{{ url('courseDetail') }}" class="shine__animate-link">
                                                    <img src="{{ asset('storage/website') }}/img/courses/course_thumb07.jpg" alt="img">
                                                </a>
                                            </div>
                                            <div class="courses__item-content">
                                                <ul class="courses__item-meta list-wrap">
                                                ...
                                                <h5 class="title"><a href="{{ url('courseDetail') }}">How To Build A Localized Website With Hugo And Strapi</a></h5>
                                                <p class="author">By <a href="#">David Millar</a></p>
                                                <div class="courses__item-bottom">
                                                    <div class="button">
                                                        <a href="{{ url('courseDetail') }}">
                                    ...
                                    <div class="col">
                                        <div class="courses__item shine__animate-item">
                                            <div class="courses__item-thumb">
                                                <a href="{{ url('courseDetail') }}" class="shine__animate-link">
                                                    <img src="{{ asset('storage/website') }}/img/courses/course_thumb08.jpg" alt="img">
                                                </a>
                                            </div>
                                            <div class="courses__item-content">
                                                <ul class="courses__item-meta list-wrap">
                                                ...
                                                <h5 class="title"><a href="{{ url('courseDetail') }}">Designing Effective Pricing Plans UX</a></h5>
                                                <p class="author">By <a href="#">Sawpawlo Mark</a></p>
                                                <div class="courses__item-bottom">
                                                    <div class="button">
                                                        <a href="{{ url('courseDetail') }}">
                                    ...
                                    <div class="col">
                                        <div class="courses__item shine__animate-item">
                                            <div class="courses__item-thumb">
                                                <a href="{{ url('courseDetail') }}" class="shine__animate-link">
                                                    <img src="{{ asset('storage/website') }}/img/courses/course_thumb09.jpg" alt="img">
                                                </a>
                                            </div>
                                            <div class="courses__item-content">
                                                <ul class="courses__item-meta list-wrap">
                                                ...
                                                <h5 class="title"><a href="{{ url('courseDetail') }}">Accelerating UX Maturity With A Breakthrough Project</a></h5>
                                                <p class="author">By <a href="#">David Millar</a></p>
                                                <div class="courses__item-bottom">
                                                    <div class="button">
                                                        <a href="{{ url('courseDetail') }}">
                                    ...
                                    <div class="col">
                                        <div class="courses__item courses__item-three shine__animate-item">
                                            ...
                                            <div class="courses__item-content">
                                                ...
                                                <h5 class="title"><a href="{{ url('courseDetail') }}">Resolving Conflicts Between Designers And Engineers</a></h5>
                                                <p class="author">By <a href="#">David Millar</a></p>
                                    ...
                                    <div class="col">
                                        <div class="courses__item courses__item-three shine__animate-item">
                                            ...
                                            <div class="courses__item-content">
                                                ...
                                                <h5 class="title"><a href="{{ url('courseDetail') }}">Powerful Image Optimization Tools for this year</a></h5>
                                                <p class="author">By <a href="#">Jenny Wilson</a></p>
                                                <p class="info">when an unknown printer took a galley of type and scrambled type specimen book It has survived not only.</p>
                                                <div class="courses__item-bottom">
                                                    <div class="button">
                                    ...
                                    <div class="col">
                                        <div class="courses__item courses__item-three shine__animate-item">
                                            ...
                                            <div class="courses__item-content">
                                                ...
                                                <h5 class="title"><a href="{{ url('courseDetail') }}">A Look At Remix And The Differences With Next.js</a></h5>
                                                <p class="author">By <a href="#">Guy Hawkins</a></p>
                                                <p class="info">when an unknown printer took a galley of type and scrambled type specimen book It has survived not only.</p>
                                                <div class="courses__item-bottom">
                                                    <div class="button">
