...
<main class="main-area fix">
  <!-- banner-area -->
  <section class="banner-area-two banner-bg-two tg-motion-effects" data-background="{{ asset('storage/website') }}/img/banner/banner_bg02.png">
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-xl-7 col-lg-6 col-md-8">
          <div class="banner__images-two tg-svg">
            <img src="{{ asset('storage/website') }}/img/banner/h2_banner_img.png" alt="img" class="main-img" />
            <div class="shape big-shape" data-aos="fade-up" data-aos-delay="600">
              <img src="{{ asset('storage/website') }}/img/banner/h2_banner_shape01.svg" alt="shape" class="injectable tg-motion-effects1" />
            </div>
            <span class="svg-icon" id="banner-svg" data-svg-icon="{{ asset('storage/website') }}/img/banner/h2_banner_shape02.svg"></span>
            <div class="about__enrolled" data-aos="fade-right" data-aos-delay="200">
              <p class="title"><span>36K+</span> Enrolled Students</p>
              <img src="{{ asset('storage/website') }}/img/others/student_grp.png" alt="img" />
            </div>
            <div class="banner__student" data-aos="fade-left" data-aos-delay="200">
              <div class="icon">
                <img src="{{ asset('storage/website') }}/img/banner/h2_banner_icon.svg" alt="img" class="injectable" />
              </div>
              <div class="content">
    ...
    <img src="{{ asset('storage/website') }}/img/banner/h2_banner_shape03.svg" alt="shape" class="line-shape-two" data-aos="fade-right" data-aos-delay="1600" />
  </section>
  <!-- banner-area-end -->
    ...
    <div class="container-fluid">
      <div class="marquee_mode">
        <div class="brand__item">
          <a href="#"><img src="{{ asset('storage/website') }}/img/brand/brand01.png" alt="brand" /></a>
          <img src="{{ asset('storage/website') }}/img/icons/brand_star.svg" alt="star" />
        </div>
        <div class="brand__item">
          <a href="#"><img src="{{ asset('storage/website') }}/img/brand/brand02.png" alt="brand" /></a>
          <img src="{{ asset('storage/website') }}/img/icons/brand_star.svg" alt="star" />
        </div>
        <div class="brand__item">
          <a href="#"><img src="{{ asset('storage/website') }}/img/brand/brand03.png" alt="brand" /></a>
          <img src="{{ asset('storage/website') }}/img/icons/brand_star.svg" alt="star" />
        </div>
        <div class="brand__item">
          <a href="#"><img src="{{ asset('storage/website') }}/img/brand/brand04.png" alt="brand" /></a>
          <img src="{{ asset('storage/website') }}/img/icons/brand_star.svg" alt="star" />
        </div>
        <div class="brand__item">
          <a href="#"><img src="{{ asset('storage/website') }}/img/brand/brand05.png" alt="brand" /></a>
          <img src="{{ asset('storage/website') }}/img/icons/brand_star.svg" alt="star" />
        </div>
        <div class="brand__item">
          <a href="#"><img src="{{ asset('storage/website') }}/img/brand/brand06.png" alt="brand" /></a>
          <img src="{{ asset('storage/website') }}/img/icons/brand_star.svg" alt="star" />
        </div>
        <div class="brand__item">
          <a href="#"><img src="{{ asset('storage/website') }}/img/brand/brand07.png" alt="brand" /></a>
          <img src="{{ asset('storage/website') }}/img/icons/brand_star.svg" alt="star" />
        </div>
        <div class="brand__item">
          <a href="#"><img src="{{ asset('storage/website') }}/img/brand/brand04.png" alt="brand" /></a>
              ...
              <div class="features__content-two">
                <div class="content-top">
                  <div class="features__icon-two">
                    <img src="{{ asset('storage/website') }}/img/icons/h2_features_icon01.svg" alt="Expert Tutors Icon" class="injectable" />
                  </div>
                  <h2 class="title">Expert Tutors</h2>
                </div>
                <p>
                  Guidance from experienced tutors for a transformative
                  educational experience.
                </p>
              </div>
              <div class="features__item-shape">
                <img src="{{ asset('storage/website') }}/img/others/features_item_shape.svg" alt="Feature Shape" class="injectable" />
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="features__item-two">
              <div class="features__content-two">
                <div class="content-top">
                  <div class="features__icon-two">
                    <img src="{{ asset('storage/website') }}/img/icons/h2_features_icon02.svg" alt="Effective Courses Icon" class="injectable" />
                  </div>
                  <h2 class="title">Effective Courses</h2>
                </div>
                <p>
                  Practical and applicable knowledge designed to enhance
                  your skills.
                </p>
              </div>
              <div class="features__item-shape">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="features__item-two">
              <div class="features__content-two">
                <div class="content-top">
                  <div class="features__icon-two">
                    <img src="{{ asset('storage/website') }}/img/icons/h2_features_icon03.svg" alt="Earn Certificate Icon" class="injectable" />
                  </div>
                  <h2 class="title">Earn Certificate</h2>
                </div>
                <p>
                  Validate achievements with certificates, adding value to
      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-6">
          <div class="faq__img-wrap tg-svg">
            ...
            <div class="faq__img faq__img-two">
              <img src="{{ asset('storage/website') }}/img/others/faq_img.png" alt="Educational Image" />
              <div class="shape-one">
                <img src="{{ asset('storage/website') }}/img/others/faq_shape01.svg" class="injectable tg-motion-effects4" alt="Shape 1" />
              </div>
              <div class="shape-two">
                <span class="svg-icon" id="faq-two-svg" data-svg-icon="{{ asset('storage/website') }}/img/others/faq_shape02.svg"></span>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="about__content">
            ...
            <p class="desc">
              Welcome to our platform, where you can discover and access
              thousands of top courses all in one place. We've curated a
              diverse range of learning opportunities to empower you on your
              educational journey. Explore, learn, and grow with us!
            </p>
      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-6 col-md-9">
          <div class="about__images work__images">
            <img src="{{ asset('storage/website') }}/img/others/about_img.png" alt="img" class="main-img" />
            <img src="{{ asset('storage/website') }}/img/others/about_shape.svg" alt="img" class="shape alltuchtopdown" />
            <a href="https://www.youtube.com/embed/5ez2buc0i8I?si=UfABArZeTxqdfi-U" class="popup-video">
        ...
        <div class="col-lg-6">
          <div class="work__content">
            <div class="section__title mb-20">
              ...
              <h2 class="title">Discover Our Free Workshops</h2>
            </div>
            <p>
              Explore exciting workshops with us! We've taken text and
              ideas, like an adventurous printer with type, to create
              engaging sessions for you.
            </p>
            <div class="work__list-wrap">
              <div class="work__list-box">
                <div class="work__list-box-top">
                  ...
                  <h4 class="title">Enjoy Live Virtual Classes</h4>
                </div>
                <p>Experience fun live classes for enjoyable learning.</p>
              </div>
              <div class="work__list-box">
                <div class="work__list-box-top">
                  <div class="icon">
                  ...
                  <h4 class="title">99% Graduates Achieved</h4>
                </div>
                <p>
                  Join our successful graduates who've thrived with our
                  workshops.
                </p>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-sm-6">
            <div class="fact__item">
              <h2 class="count">
                <span class="odometer" data-count="45"></span>K+
              </h2>
              <p>Active Students</p>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6">
            <div class="fact__item">
              <h2 class="count">
                <span class="odometer" data-count="89"></span>+
              </h2>
              <p>Faculty Courses</p>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6">
            <div class="fact__item">
              <h2 class="count">
                <span class="odometer" data-count="156"></span>K
              </h2>
              <p>Best Professors</p>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6">
            <div class="fact__item">
              <h2 class="count">
                <span class="odometer" data-count="42"></span>K
              </h2>
              <p>Award Achieved</p>
            </div>
          </div>
  ...
  <!-- instructor-area -->
  <section class="instructor__area-three instructor__bg" data-background="{{ asset('storage/website') }}/img/bg/instructor_bg.jpg">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-6 col-lg-8">
          <div class="section__title text-center mb-40">
          ...
          <div class="swiper-container instructor-active">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="instructor__item-three">
                  <div class="instructor__thumb-three">
                    <img src="{{ asset('storage/website') }}/img/instructor/h2_instructor01.png" alt="img" />
                    <div class="shape-one">
                      <img src="{{ asset('storage/website') }}/img/instructor/h2_instructor_img_shape01.svg" alt="img" class="injectable" />
                    </div>
                  </div>
              ...
              <div class="swiper-slide">
                <div class="instructor__item-three">
                  <div class="instructor__thumb-three">
                    <img src="{{ asset('storage/website') }}/img/instructor/h2_instructor02.png" alt="img" />
                    <div class="shape-one">
                      <img src="{{ asset('storage/website') }}/img/instructor/h2_instructor_img_shape01.svg" alt="img" class="injectable" />
                    </div>
                  </div>
              ...
              <div class="swiper-slide">
                <div class="instructor__item-three">
                  <div class="instructor__thumb-three">
                    <img src="{{ asset('storage/website') }}/img/instructor/h2_instructor03.png" alt="img" />
                    <div class="shape-one">
                      <img src="{{ asset('storage/website') }}/img/instructor/h2_instructor_img_shape01.svg" alt="img" class="injectable" />
                    </div>
                  </div>
              ...
              <div class="swiper-slide">
                <div class="instructor__item-three">
                  <div class="instructor__thumb-three">
                    <img src="{{ asset('storage/website') }}/img/instructor/h2_instructor04.png" alt="img" />
                    <div class="shape-one">
                      <img src="{{ asset('storage/website') }}/img/instructor/h2_instructor_img_shape01.svg" alt="img" class="injectable" />
                    </div>
                  </div>
              ...
              <div class="swiper-slide">
                <div class="instructor__item-three">
                  <div class="instructor__thumb-three">
                    <img src="{{ asset('storage/website') }}/img/instructor/h2_instructor05.png" alt="img" />
                    <div class="shape-one">
                      <img src="{{ asset('storage/website') }}/img/instructor/h2_instructor_img_shape01.svg" alt="img" class="injectable" />
                    </div>
                  </div>
          ...
          <div class="instructor-slider-dot">
            <div class="swiper instructor-nav">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <button>
                    <img src="{{ asset('storage/website') }}/img/instructor/instructor_nav01.png" alt="img" />
                  </button>
                </div>
                <div class="swiper-slide">
                  <button>
                    <img src="{{ asset('storage/website') }}/img/instructor/instructor_nav02.png" alt="img" />
                  </button>
                </div>
                <div class="swiper-slide">
                  <button>
                    <img src="{{ asset('storage/website') }}/img/instructor/instructor_nav03.png" alt="img" />
                  </button>
                </div>
                <div class="swiper-slide">
                  <button>
                    <img src="{{ asset('storage/website') }}/img/instructor/instructor_nav04.png" alt="img" />
                  </button>
                </div>
                <div class="swiper-slide">
                  <button>
    ...
    <div class="instructor__shape">
      <img src="{{ asset('storage/website') }}/img/instructor/h2_instructor_shape.png" alt="img" class="alltuchtopdown" />
    </div>
  </section>
  <!-- instructor-area-end -->
  ...
  <section class="newsletter__area">
      ...
      <div class="row align-items-center">
        <div class="col-lg-4">
          <div class="newsletter__img-wrap">
            <img src="{{ asset('storage/website') }}/img/others/newsletter_img.png" alt="img" />
            <img src="{{ asset('storage/website') }}/img/others/newsletter_shape01.png" alt="img" data-aos="fade-up" data-aos-delay="400" />
            <img src="{{ asset('storage/website') }}/img/others/newsletter_shape02.png" alt="img" class="alltuchtopdown" />
          </div>
        </div>
        <div class="col-lg-8">
    ...
    <div class="newsletter__shape">
      <img src="{{ asset('storage/website') }}/img/others/newsletter_shape03.png" alt="img" data-aos="fade-left" data-aos-delay="400" />
    </div>
  </section>
  <!-- newsletter-area-end -->
  ...
  <section class="event__area section-pt-120 section-pb-90">
        ...
        <div class="row">
          <div class="col-30">
            <div class="event__content">
              ...
              <p>
                Join us for upcoming events where you can learn, share, and
                have a great time with like-minded individuals. Don't miss
    ...
    <div class="event__shape">
      <img src="{{ asset('storage/website') }}/img/events/event_shape.png" alt="img" class="alltuchtopdown" />
    </div>
  </section>
  <!-- event-area-end -->
      ...
      <div class="instructor__item-wrap-two">
        <div class="row">
          <div class="col-xl-6">
            <div class="instructor__item-two tg-svg">
              <div class="instructor__thumb-two">
                <img src="{{ asset('storage/website') }}/img/instructor/instructor_two01.png" alt="img" />
                <div class="shape-one">
                  <img src="{{ asset('storage/website') }}/img/instructor/instructor_shape01.svg" alt="img" class="injectable" />
                </div>
                <div class="shape-two">
                  <span class="svg-icon" id="instructor-svg" data-svg-icon="{{ asset('storage/website') }}/img/instructor/instructor_shape02.svg"></span>
                </div>
              </div>
          ...
          <div class="col-xl-6">
            <div class="instructor__item-two tg-svg">
              <div class="instructor__thumb-two">
                <img src="{{ asset('storage/website') }}/img/instructor/instructor_two02.png" alt="img" />
                <div class="shape-one">
                  <img src="{{ asset('storage/website') }}/img/instructor/instructor_shape01.svg" alt="img" class="injectable" />
                </div>
                <div class="shape-two">
                  <span class="svg-icon" id="instructor-svg-two" data-svg-icon="{{ asset('storage/website') }}/img/instructor/instructor_shape02.svg"></span>
                </div>
              </div>
              <div class="instructor__content-two">
                <h3 class="title">
