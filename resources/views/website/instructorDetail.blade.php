                    ...
                    <div class="instructor__details-wrap">
                        <div class="instructor__details-info">
                            <div class="instructor__details-thumb">
                                <img src="{{ asset('storage/website') }}/img/instructor/instructor_details_thumb.png" alt="img">
                            </div>
                        ...
                        <div class="courses-area section-pb-90" data-background="{{ asset('storage/website') }}/img/bg/courses_bg.jpg">
                            <div class="container">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-6">
                                            <div class="section__title text-center mb-40">
                                                ...
                                                <p class="desc">Embark on a learning journey with My Courses – where knowledge meets curiosity!</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
