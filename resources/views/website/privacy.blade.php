                ...
                <div class="col-xl-12">
                    <div class="instructor__details-wrap">
                        <div class="instructor__details-biography">
                            ...
                            <p>Welcome to SkillGro. We are committed to protecting your privacy and providing a safe online
                                learning environment. This Privacy Policy explains how we collect, use, and safeguard your
                                personal information when you use our online courses.</p>

                            <h5>Information We Collect</h5>
                            <p>We may collect various types of information, including but not limited to:
                                - Personal information such as your name, email address, and other details provided during
                                ...
                                - Communication data, including messages and communications with instructors or other users.
                            </p>
                            ...
                            <p>We implement security measures to protect your personal information from unauthorized access,
                                disclosure, alteration, and destruction. However, please be aware that no method of
                                transmission over the internet or electronic storage is 100% secure.</p>

                            <h5>Third-Party Services</h5>
                            <p>We may use third-party services (e.g., payment processors) to facilitate our services. These
                                services have their own privacy policies, and we encourage you to review them.</p>

                            <h5>Your Choices</h5>
                            <p>You can manage your account settings and communication preferences. You may also choose to
                                delete your account, but please note that certain information may be retained for legal or
                                business purposes.</p>

                            <h5>Changes to This Privacy Policy</h5>
                            <p>We may update this Privacy Policy periodically. We will notify you of any significant changes
                                by posting the updated policy on our website.</p>

                            <p>If you have any questions or concerns about our Privacy Policy, please contact us at
                                SkillGro@gmail.com.</p>
                        </div>
                    </div>
                </div>
            </div>
