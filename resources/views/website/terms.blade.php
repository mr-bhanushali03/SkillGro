                ...
                <div class="col-xl-12">
                    <div class="instructor__details-wrap">
                        <div class="instructor__details-biography">
                            ...
                            <p>Welcome to SkillGro. By accessing and using our online courses, you agree to comply with and
                                be bound by the following terms and conditions:</p>

                            <h5>1. Registration and Account</h5>
                            <p>a. To access certain features of the online courses, you may be required to register for an
                                account.
                                b. You are responsible for maintaining the confidentiality of your account information and
                                password.</p>

                            <h5>2. Course Content</h5>
                            <p>a. The content of the courses, including text, videos, and materials, is for educational
                                purposes only.
                                b. You may not reproduce, distribute, or modify the course content without explicit
                                permission.</p>
                            ...
                            <p>a. You agree to abide by a code of conduct that promotes a positive and respectful learning
                                environment.
                            ...
                            <h5>6. Termination</h5>
                            <p>a. SkillGro reserves the right to terminate your access to the courses for violations of
                                these terms.
                                b. Termination may result in the loss of access to course materials and account information.
                            </p>

                            <h5>7. Changes to Terms and Conditions</h5>
                            <p>a. SkillGro may update these terms and conditions from time to time.
                                b. Continued use of the platform after changes constitutes acceptance of the modified terms.
                            </p>
